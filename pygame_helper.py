...
class PyGameHelper:
    ...
    def __init__(self):
        ...
        # 初始化Pygame，找到Sea of Thieves窗口区域，并移动
        # Pygame窗口覆盖盗贼之海
        pygame.init()
        ...
        z_order = (NOT_TOPMOST, TOPMOST)[True]  # choose a flag according to bool 根据bool选择一个标志
